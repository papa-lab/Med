...
export default function LibrarySection() {
  ...
  return (
    <section 
      ref={sectionRef}
      id="resources"
      className="med-section-pinned bg-med-bg dark:bg-med-bg-dark med-pattern z-[100]"
    >
      <div 
        ref={megaCardRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-med-text-secondary dark:text-gray-400 mb-8 max-w-md">
              Notes, slides, audio summaries, and diagrams—organized by subject.
            </p>
            <div className="flex items-center gap-4">
              ...
              <button className="text-sm font-medium text-med-mint hover:underline flex items-center gap-1">
          ...
          >
            ...
            >
              <BookOpen className="w-4 h-4 text-med-mint" />
