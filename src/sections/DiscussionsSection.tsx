...
export default function DiscussionsSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="med-section-pinned bg-med-bg dark:bg-med-bg-dark med-pattern z-[90]"
    >
      <div 
        ref={megaCardRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-med-text-secondary dark:text-gray-400 mb-8 max-w-md">
              Ask questions, share resources, and explain concepts to others.
            </p>
            <div className="flex items-center gap-4">
              <button className="med-btn-primary flex items-center gap-2 bg-med-lavender hover:bg-med-lavender/90">
                <MessageSquare className="w-4 h-4" />
                Open discussions
                <ArrowRight className="w-4 h-4" />
              </button>
              <button className="text-sm font-medium text-med-lavender hover:underline flex items-center gap-1">
