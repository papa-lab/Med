...
export default function TelegramSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="med-section-pinned bg-med-bg dark:bg-med-bg-dark med-pattern z-[120]"
    >
      <div 
        ref={megaCardRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-med-text-secondary dark:text-gray-400 mb-8 max-w-md">
              Get daily questions, reminders, and community updates—right in Telegram.
            </p>
            <div className="flex items-center gap-4">
              ...
              <button className="text-sm font-medium text-med-sky hover:underline">
                How it works
              </button>
            </div>
          </div>
          ...
          >
            ...
            >
              <Smartphone className="w-4 h-4 text-med-sky" />
