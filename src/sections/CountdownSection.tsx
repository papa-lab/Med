...
export default function CountdownSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="med-section-pinned bg-med-bg dark:bg-med-bg-dark med-pattern z-[110]"
    >
      <div 
        ref={megaCardRef}
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          >
            ...
            >
              <Clock className="w-4 h-4 text-med-coral" />
            ...
            <p className="text-base lg:text-lg text-med-text-secondary dark:text-gray-400 mb-8 max-w-md">
              Exam countdown, daily tasks, and a revision calendar that adapts to your pace.
            </p>
