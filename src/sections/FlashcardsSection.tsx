...
export default function FlashcardsSection() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="med-section-pinned bg-med-bg dark:bg-med-bg-dark med-pattern z-[80]"
    >
      <div 
        ref={megaCardRef}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          <div
            ...
            className="med-card p-8 lg:p-12 flex flex-col justify-center
                     bg-gradient-to-br from-med-cream/10 to-transparent
                     border-med-cream/30"
          >
            ...
            <p className="text-base lg:text-lg text-med-text-secondary dark:text-gray-400 mb-8 max-w-md">
              Spaced repetition for drugs, anatomy, and protocols—without the clutter.
            </p>
            <div className="flex items-center gap-4">
              <button className="med-btn-primary flex items-center gap-2 bg-med-cream text-med-text hover:bg-med-cream/90">
          ...
          >
            ...
            >
              <Zap className="w-4 h-4 text-med-cream" />
